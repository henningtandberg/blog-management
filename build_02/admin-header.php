...
<head>
    ...
    <!-- Title -->
    <title>Henning Tandberg - Admin Panel</title>
</head>
<!--Head end-->
...
<nav class="navbar navbar-default navbar-fixed-left" role="navigation">
    <ul class="nav navbar-nav">
        ...
        <li><a href=<?php echo $sitelink."home"; ?>>DASHBOAD</a></li>

        <li><a href=<?php echo $sitelink."news"; ?>>NYHETER</a></li>

        <li><!-- BLOGG START -->
            <a class="dropdown-toggle" data-toggle="dropdown" href="">BLOGG
        ...
        <li><a href=<?php echo $sitelink."arcive"; ?>>ARKIV</a></li>

        <li><a href=<?php echo $sitelink."pages"; ?>>SIDER</a></li>
